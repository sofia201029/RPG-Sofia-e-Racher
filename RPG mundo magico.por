programa {
  funcao inicio() {
    ...
    leia(nome)
    escreva("a vida do usuario, pobre desde a infancia, pai morreu na guerra, ajuda a mae em uma pequena padaria, um dia guardas do reino sequestram sua mae, derrotado ele treina por um ano com um amigo de seu pai para se infiltrar e resgatar sua mae")
    ...
    leia(botao)
    escreva("infelizmente o usuario encontra guardas da realeza levando sua mae, \nlogo o usuario vai ate os guardas tentando resgatar sua mae mais infeliz, os guardas se irritam e batem nele, como ele era muito novo e fraco, nao pode ajudar, depois um velho amigo de seu pai aparece determinado a ajudar o usuario a melhorar suas abilidades durante um ano o usuario treina. agora mais alto e mais forte vai se infiltrar no castelo da realeza, agora o usuario tem a missao de colher cinco informaçoes importantes dos imperadores do castelo,\n para isso ande pelos aposentos do imperadores um, apertando os botoes de direçao:  ")
